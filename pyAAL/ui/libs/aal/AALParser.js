...
var literalNames = [ 'null', "'('", "')'", "'['", "']'", "'{'", "'}'", "'.'", 
                     ...
                     "'<=>'", "'MUST'", "'MUSTNOT'", "'ALWAYS'", "'NEVER'", 
                     "'SOMETIME'", "'UNTIL'", "'UNLESS'", "'NEXT'", "'PERMIT'", 
                     "'DENY'", "'FORALL'", "'EXISTS'", "'SUBJECT'", "'REQUIRED'", 
                     "'PROVIDED'", "'PURPOSE'", "'EXTENDS'", "'ATTRIBUTES'", 
                     "'ACTIONS'", "'MACRO'", "'CALL'", "'LOAD'", "'CHECK'", 
                     "'APPLY'", "'EXEC'", "'BEHAVIOR'", "'ENV'", "'UNION'", 
                     "'INTERSEC'", 'null', 'null', 'null', 'null', 'null', 
...
AALParser.O_equiv = 30;
AALParser.T_must = 31;
AALParser.T_mustnot = 32;
AALParser.T_always = 33;
AALParser.T_never = 34;
AALParser.T_sometime = 35;
AALParser.T_until = 36;
AALParser.T_unless = 37;
AALParser.T_next = 38;
AALParser.A_permit = 39;
AALParser.A_deny = 40;
AALParser.Q_forall = 41;
AALParser.Q_exists = 42;
AALParser.M_subject = 43;
AALParser.M_rservice = 44;
AALParser.M_pservice = 45;
AALParser.M_purpose = 46;
AALParser.M_extends = 47;
AALParser.M_attr = 48;
AALParser.M_actions = 49;
AALParser.M_macro = 50;
AALParser.M_call = 51;
AALParser.M_load = 52;
AALParser.M_check = 53;
AALParser.M_apply = 54;
AALParser.M_exec = 55;
AALParser.M_behavior = 56;
AALParser.M_env = 57;
AALParser.M_union = 58;
AALParser.M_intersec = 59;
AALParser.C_clause = 60;
AALParser.C_usage = 61;
AALParser.C_audit = 62;
AALParser.C_rectification = 63;
AALParser.C_violation = 64;
AALParser.ID = 65;
AALParser.INT = 66;
AALParser.NEWLINE = 67;
AALParser.WS = 68;
AALParser.BLANK = 69;
AALParser.STRING = 70;
AALParser.COMMENT = 71;
AALParser.MLCOMMENT = 72;
AALParser.MCODE = 73;
AALParser.NEGATION = 74;
AALParser.CONJUNCTION = 75;
AALParser.DISJUNCTION = 76;
AALParser.IMPLICATION = 77;
AALParser.EQUIVALENCE = 78;
AALParser.CONSTANTS = 79;
AALParser.PREDICATE = 80;
...
AALParser.prototype.aalprog = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << AALParser.D_service) | (1 << AALParser.D_agent) | (1 << AALParser.D_data) | (1 << AALParser.D_clause) | (1 << AALParser.D_type))) !== 0) || ((((_la - 50)) & ~0x1f) == 0 && ((1 << (_la - 50)) & ((1 << (AALParser.M_macro - 50)) | (1 << (AALParser.M_call - 50)) | (1 << (AALParser.M_load - 50)) | (1 << (AALParser.M_check - 50)) | (1 << (AALParser.M_apply - 50)) | (1 << (AALParser.M_exec - 50)) | (1 << (AALParser.M_behavior - 50)) | (1 << (AALParser.M_env - 50)) | (1 << (AALParser.ID - 50)) | (1 << (AALParser.COMMENT - 50)) | (1 << (AALParser.MLCOMMENT - 50)))) !== 0)) {
            this.state = 264;
            switch(this._input.LA(1)) {
...
AALParser.prototype.typeDec = function() {
    ...
    try {
        ...
        this.state = 390;
        _la = this._input.LA(1);
        if(_la===AALParser.O_not || ((((_la - 47)) & ~0x1f) == 0 && ((1 << (_la - 47)) & ((1 << (AALParser.M_extends - 47)) | (1 << (AALParser.M_union - 47)) | (1 << (AALParser.M_intersec - 47)))) !== 0)) {
            this.state = 389;
            this.type_super();
        }
...
Type_superContext.prototype.M_union = function() {
    return this.getToken(AALParser.M_union, 0);
};

Type_superContext.prototype.M_intersec = function() {
    return this.getToken(AALParser.M_intersec, 0);
};

Type_superContext.prototype.O_not = function() {
...
BooleanOpContext.prototype.O_equiv = function() {
    return this.getToken(AALParser.O_equiv, 0);
};
...
AALParser.prototype.booleanOp = function() {
    ...
    try {
        ...
        this.state = 514;
        _la = this._input.LA(1);
        if(!(((((_la - 21)) & ~0x1f) == 0 && ((1 << (_la - 21)) & ((1 << (AALParser.O_or - 21)) | (1 << (AALParser.O_and - 21)) | (1 << (AALParser.O_onlywhen - 21)) | (1 << (AALParser.O_equiv - 21)) | (1 << (AALParser.T_until - 21)) | (1 << (AALParser.T_unless - 21)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
            this.consume();
...
AuthorContext.prototype.actionExp = function() {
    return this.getTypedRuleContext(ActionExpContext,0);
};
...
AALParser.prototype.action = function() {
    ...
    try {
        ...
        this.state = 592;
        _la = this._input.LA(1);
        if(_la===AALParser.T__11 || ((((_la - 65)) & ~0x1f) == 0 && ((1 << (_la - 65)) & ((1 << (AALParser.ID - 65)) | (1 << (AALParser.INT - 65)) | (1 << (AALParser.STRING - 65)))) !== 0)) {
            this.state = 591;
            this.exp();
        }
...
ModalContext.prototype.T_next = function() {
    return this.getToken(AALParser.T_next, 0);
};
...
AALParser.prototype.modal = function() {
    ...
    try {
        ...
        this.state = 610;
        _la = this._input.LA(1);
        if(!(((((_la - 31)) & ~0x1f) == 0 && ((1 << (_la - 31)) & ((1 << (AALParser.T_must - 31)) | (1 << (AALParser.T_mustnot - 31)) | (1 << (AALParser.T_always - 31)) | (1 << (AALParser.T_never - 31)) | (1 << (AALParser.T_sometime - 31)) | (1 << (AALParser.T_next - 31)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
            this.consume();
