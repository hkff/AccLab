...
AALParser.prototype.modal = function() {
    ...
    try {
        ...
        this.state = 607;
        _la = this._input.LA(1);
        if(!(((((_la - 30)) & ~0x1f) == 0 && ((1 << (_la - 30)) & ((1 << (AALParser.T_must - 30)) | (1 << (AALParser.T_mustnot - 30)) | (1 << (AALParser.T_always - 30)) | (1 << (AALParser.T_never - 30)) | (1 << (AALParser.T_sometime - 30)) | (1 << (AALParser.T_next - 30)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
            this.consume();
