#!/usr/bin/python3.4
"""
aalc version 2.1 main AccLab program
...
def aalc(file, use_shell: bool=False, check: bool=False, monodic: bool=False, compile: bool=False,
         ...
         show_ast: bool=False, timeout=20, no_exec=False, web=False):
    """
    Parse AAL.
...
def main(argv):
    ...
    inputfile = ""
    outputfile = ""
    help_str_extended = "AAL tools set V 2.1 . aalc is a part of Acclab tool.\n" + \
