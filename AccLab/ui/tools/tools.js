...
visualEditor.ui.tools = {
	...
	toolsRegistrator: function() {
		...
		this.tools.push(new visualEditor.ui.tools.pasteTool());
		...
		this.tools.push(new visualEditor.ui.tools.exitTool());
...
//
//////////////////////////////////////////////////////////
visualEditor.ui.tools.pasteTool = visualEditor.ui.tool.extend({
	NAME : "visualEditor.ui.tools.pasteTool",

	view: function(parent) {
		this.pasteBtn = $('<div id="pasteBtn" class="btn-action fa fa-paste fa-lg"/>');
		parent.actionsPanel.append(this.pasteBtn);
...
visualEditor.ui.tools.deleteTool = visualEditor.ui.tool.extend({
	...
	control: function(parent) {
		this.deleteBtn.click(function(e){
			visualEditor.ui.canvas.getCommandStack().execute(new draw2d.command.CommandDelete(visualEditor.ui.canvas.getCurrentSelection()));
		});
	},
...
//
//////////////////////////////////////////////////////////
visualEditor.ui.tools.exitTool = visualEditor.ui.tool.extend({
	NAME : "visualEditor.ui.tools.exitTool",

	view: function(parent) {
		this.exitBtn = $('<div id="exitBtn" class="btn-action fa fa-power-off fa-lg"/>');
		parent.actionsPanel.append(this.exitBtn);
	},
...
visualEditor.ui.tools.genTSPASSTool = visualEditor.ui.tool.extend({
	...
	view: function(parent) {
		this.genTSPASSTool = $('<div id="genTSPASSBtn" class="btn-action fa fa-file-text fa-lg"/>');
		...
		this.genTSPASSTool.click(function(e){
            ...
            var dType = "text";
				var req = $.ajax({
					dataType: dType,
					type:'POST',
					url: visualEditor.backend + "files.php",//?action=compileAAL&file="+file,
					data: {action: "compileAAL", file: file},
